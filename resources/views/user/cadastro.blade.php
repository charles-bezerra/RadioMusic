              ...
              <div class="row">
                  <div class="col-3">
                      <div class="form-group">
                        ...
                        <input type="text" required='required' class="form-control" id="Nome" placeholder="Seu nome" name='nome' value="{{old('name')}}">
                      </div>
                  </div>
                  <div class="col-9">
                      <div class="form-group">
                        <label for="Sobrenome">Sobrenome</label>
                        <input type="text" required='required' class="form-control" id="Sobrenome" placeholder="Seu sobrenome" name='snome' value="{{old('sname')}}">
                      </div>
                  </div>
              </div>
              <div class="row">
